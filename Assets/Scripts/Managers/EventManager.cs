...
public class EventManager : MonoBehaviour
{
    ...
    void Start()  
    {
        ...
        {
            animator1A = magicObj.transform.GetChild(0).gameObject.GetComponent<Animator>();  // magicObj?ÔøΩÔøΩ step1 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
            animator1B = magicObj.transform.GetChild(1).gameObject.GetComponent<Animator>();  // magicObj?ÔøΩÔøΩ step2 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
            animator1C = magicObj.transform.GetChild(2).gameObject.GetComponent<Animator>();  // magicObj?ÔøΩÔøΩ step3 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
            animator2A = specialObj.transform.GetChild(0).gameObject.GetComponent<Animator>();  // speicalObj?ÔøΩÔøΩ step1 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
            animator2B = specialObj.transform.GetChild(1).gameObject.GetComponent<Animator>();  // speicalObj?ÔøΩÔøΩ step2 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
            animator3A = stoneObj.transform.GetChild(0).gameObject.GetComponent<Animator>();  // stoneObj?ÔøΩÔøΩ step1 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
            animator3B = stoneObj.transform.GetChild(1).gameObject.GetComponent<Animator>();  // stoneObj?ÔøΩÔøΩ step2 ?ÔøΩÔøΩ?ÔøΩÔøΩÎ©îÏù¥?ÔøΩÔøΩ Ôø???ÔøΩÔøΩ?ÔøΩÔøΩÔø??
    ...
    {   
        ...
        print("ÎÇòÏù¥ÌîÑ ÌÇ§2 = "  + PlayerPrefs.GetInt("knifeActive"));

        TrainingDummyGlow glowing = GameObject.Find("training_dummy_mesh").GetComponent<TrainingDummyGlow>();

        //[**** Í≤åÏûÑ ?ÔøΩÔøΩÍ≥ÑÔøΩ?? explain window ****] 
        explainUI.SetActive(true);  
        yield return new WaitForSeconds(10);  
        explainUI.SetActive(false); 

        //[****ÎßàÎ≤ï ?ÔøΩÔøΩÔø?? ?ÔøΩÔøΩÔø?? Î∞©Î≤ï window***] 
        //step1 UI
        ...
        glowing.SetGlowing();
        animator1A.SetBool("isDone", true);  //?ÔøΩÔøΩ?ÔøΩÔøΩÔø?? 
        ...
        glowing.SetGlowing();
        animator1B.SetBool("isDone", true);  //?ÔøΩÔøΩ?ÔøΩÔøΩÔø??
        yield return new WaitForSeconds(2);
        ...
        //[****?ÔøΩÔøΩÔø?? ?ÔøΩÔøΩÔø?? ?ÔøΩÔøΩÔø?? Î∞©Î≤ï window***]
        //step1 UI
        ...
        //[****?ÔøΩÔøΩ?ÔøΩÔøΩ?ÔøΩÔøΩ ?ÔøΩÔøΩÔø?? Î∞©Î≤ï window***]
        //step1 UI
